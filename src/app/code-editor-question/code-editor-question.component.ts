...
@Component({
    selector: 'app-code-editor-question',
    templateUrl: './code-editor-question.component.html',
    styleUrls: ['./code-editor-question.component.css']
})
export class CodeEditorQuestionComponent implements OnInit {
